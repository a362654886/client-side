...
const UserPostMessageManagement = (): JSX.Element => {
  ...
  const getMessages = async () => {
    setLoading(true);
    const messageResult = await messagesGet(
      "",
      1,
      10,
    ...
    setAllMessages(messageResult?.messages as Message[]);
    setCount((messageResult as MessageReturnBody).count);
    setLoading(false);
  };
...
export default UserPostMessageManagement;
