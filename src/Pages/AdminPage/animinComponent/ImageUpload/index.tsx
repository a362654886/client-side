  ...
  const getBody = () => {
    return (
      <Upload showUploadList={false} onChange={(e) => handleChange(e)}>
        <div style={{ display: "flex", marginTop: "10px",marginLeft: "8px" }}>
          <img style={{ height: "24px", width: "24px",marginTop: "6px" }} src={add} />
          <p style={{ height: "36px", marginTop: "8px", marginLeft: "4px" }}>
            Icon
          </p>
        </div>
      </Upload>
